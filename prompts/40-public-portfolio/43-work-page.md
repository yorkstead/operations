...
In `yorkstead-website`, refine the work/case-study experience to separate verified client/internal work from fictional demos and products. Require evidence, permissions, honest status, problem/workflow/result structure, and approved media.

Acceptance: taxonomy cannot mislead; illustrative metrics are labeled; every published artifact passes `docs/PORTFOLIO_REVIEW.md`; existing work is preserved.
