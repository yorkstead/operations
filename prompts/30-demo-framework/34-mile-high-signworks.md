...
Create a sign fabrication and installation scenario spanning estimate, design/revision approval, material, fabrication operations, permits/outsourcing references, packaging, crew installation, proof of work, and closeout. Reuse platform contracts and preserve visual identity.

Acceptance: records reconcile across the full story; revision approval prevents wrong-file release; fabricated and field work remain distinguishable; reset, mobile use, permissions, and simulated communications are verified.
