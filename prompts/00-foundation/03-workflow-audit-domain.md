...
Define and implement the internal Workflow Audit domain used to diagnose operational friction before prescribing software. Support versioned question sets, engagements, answers, evidence notes, opportunity findings, confidence, recommendations, and a written briefing. Separate measured facts from estimates. Provide a focused admin/user flow and a printable/exportable result without promising fabricated savings.

Acceptance: an authorized user can create an audit, complete representative questions, record evidence, generate a transparent score/opportunity summary, and export a labeled briefing; formulas are tested and documented; public lead capture remains outside this repository.
