...
Complete `docs/PORTFOLIO_REVIEW.md` for each public artifact and demo. Verify classification, permissions, claim evidence, synthetic-data labeling, demo safety, screenshots, links, metadata, analytics, accessibility, visual consistency, status/fallback, and unpublish procedure. Produce a concise owner/admin handoff and prioritized next-release list.

Acceptance: nothing unreviewed is represented as client work or production-ready; public and operations repositories remain cleanly separated; all global-style changes are explicitly disclosed.
