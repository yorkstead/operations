...
Implement versioned organization settings, module entitlements, terminology mapping, supported visual identity fields, workflow configuration boundaries, and an administrative control surface. Follow `docs/CUSTOMIZATION.md`; do not create customer code forks.

Acceptance: settings validate, preview, audit, migrate, and roll back; unsafe invariants are not configurable; disabled modules are enforced server-side; admin documentation is updated.
