...
Build demand/shortage signals, requisitions, supplier options, purchase orders, approvals, expected receipts, partial receipts, and links to inventory/jobs. Recommendations must show price, lead time, minimums, and evidence; users make the decision.

Acceptance: approval thresholds, revision/cancellation, duplicate order prevention, units/currency, late/partial states, receiving handoff, audit, and permissions are tested.
