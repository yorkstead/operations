# ShopFloor and Digital Traveler
...
Build a mobile-first production-control slice: resources/work centers, operations, dispatch board, start/pause/complete, quantities, blockers, QR-based traveler lookup, and a role-focused “today” view. Workers should see only what they need; managers see schedule/flow signals. Do not build an optimizer yet.

Acceptance: a released job moves through ordered operations with concurrency protection, permissions, offline/poor-network-safe feedback, timestamps, audit trail, and narrow-screen/scan-path tests.
