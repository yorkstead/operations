...
Build inspection plans/results, pass/fail capture, defects, photos, nonconformance reports, disposition, containment, corrective actions, remake/scrap cost inputs, and links to jobs, parts, operations, material, and employees. Keep AI categorization assistive and reviewable.

Acceptance: floor capture is fast and mobile; approvals and segregation of duties are enforced; first-pass yield and defect metrics trace to records; closed NCR history is immutable except controlled corrections.
