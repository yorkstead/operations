...
Build quote intake, revisions, line items, quantities, material/operation/labor/outsourcing/freight/overhead inputs, margin policy, approvals, customer-ready document, acceptance/expiry, and quote-to-job handoff. Keep estimates transparent and distinguish historical suggestions from approved rates.

Acceptance: money/rounding/tax assumptions are documented; unauthorized margin/discount changes fail; revisions remain traceable; accepted quote creates one idempotent job handoff; no accounting claim is implied.
