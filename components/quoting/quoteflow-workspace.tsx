...
const SAMPLE_QUOTES: Quote[] = [
  ...
  },
  {
    ...
    customerName: "Denver Express & No Limit Trucking",
    customerContactEmail: "schapman@denverexpressco.com",
    title: "ReworkFlow™ Cross-Dock Intake & Terminal Platform - Complete Software Asset Buyout",
    status: "approved",
    currentRevisionNumber: 1,
    minMarginThresholdPercent: 30,
    requiresExecutiveApproval: false,
    ...
    consultingScope: {
      ...
      includedIntegrations: [
        "Stranded Driver Bay Hold Portal (/reserve)",
        "Forklift Glove-Friendly Terminal (/dock)",
        "Dispatcher Sound-Alert Ops Board (/office)",
        "I-70 Corridor Google Maps Landing Simulator (/maps)",
        "HOTWAV R9 Pro Rugged Tablets & RAM Tough-Claw Staging",
        "SpinFlow Agency Complete Codebase Buyout & Handover",
      ],
      deliverableSummary: [
        "Stranded driver rate calculator & 45-min bay hold",
        "Glove-friendly photo intake, pallet breakdown & driver signature pad",
        "Real-time audio alert board & QuickBooks CSV export",
        "15-mile protected non-compete covenant (I-70/I-25)",
        "Zero license rent, full codebase ownership buyout",
      ],
      paymentMilestones: [
        {
          id: "pms_de_1",
        ...
        {
          id: "pms_de_2",
          milestoneName: "30% Staging Deployment & Dock Walkthrough",
          percentage: 30,
          amountCents: 285000,
        ...
        lineItems: [
          {
            id: "qli_de_1",
            lineItemNumber: 1,
            partDescription: "ReworkFlow™ Cross-Dock Intake & Terminal Platform - Complete Software Asset Buyout",
            drawingNumber: "PRP-2026-DENVER-EXPRESS",
            revision: "1.0",
            quantity: 1,
            costBreakdown: {
              materialCostCents: 0,
              laborCostCents: 551000,
              machineCostCents: 0,
              outsourcingCostCents: 0,
              freightCostCents: 0,
              overheadCostCents: 0,
              totalCostCents: 551000,
            },
...
const SAMPLE_QUOTE_METRICS: QuoteMetricsSummary = {
  activeQuotesCount: 3,
  totalPipelineValueCents: 2907500,
